...
urlpatterns = [
    ...
    path('slot_actions', SlotActionListView.as_view(), name='api_clients_slot_actions_list'),
    path('slot_actions/<int:pk>', SlotActionOneView.as_view(), name='api_clients_slot_action_one'),
]
